...
{
    const char* pszTimestamp = "Winston Churchill was born November 30, 1874, Blenheim Palace, Oxfordshire, England";
    const CScript genesisOutputScript = CScript() << ParseHex("022284710fa659ad5021690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1704984174, 2001405803, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x45197176070d10bed14d9f6cbd437abbedfc14bf44095775f07077dca77f6d4b"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e761ee70512e7004c409fc6815f918c4e5352c28bbb354577abdb7f5e6feeb6"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("217.199.255.57", "217.199.255.57", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("fiticointools.com", "dnsseed.fiticointools.com"));
        //vSeeds.push_back(CDNSSeedData("fiticoinpool.org", "dnsseed.fiticoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x45197176070d10bed14d9f6cbd437abbedfc14bf44095775f07077dca77f6d4b"))
        ...
        chainTxData = ChainTxData{
            ...
            1704984174, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1704984174, 3489189, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc989b279acf9d7f1156b8f3774f4371109cc7d7664685d58e9e00abf90951b73"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e761ee70512e7004c409fc6815f918c4e5352c28bbb354577abdb7f5e6feeb6"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("217.199.255.57", "217.199.255.57"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.fiticoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xc989b279acf9d7f1156b8f3774f4371109cc7d7664685d58e9e00abf90951b73")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1704984174, 1, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x47fb4e95c4c05d05f7f0dc5e6b96e5de0fc37361249802129464adb7a106bfec"));
        assert(genesis.hashMerkleRoot == uint256S("0x5e761ee70512e7004c409fc6815f918c4e5352c28bbb354577abdb7f5e6feeb6"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x47fb4e95c4c05d05f7f0dc5e6b96e5de0fc37361249802129464adb7a106bfec"))
        };
