...
const char * const BITCOIN_CONF_FILENAME = "fiticoin.conf";
const char * const BITCOIN_PID_FILENAME = "fiticoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Fiticoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Fiticoin";
#else
    // Unix
    return pathRet / ".fiticoin";
#endif
#endif
}
