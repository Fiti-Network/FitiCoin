...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/fiticoin-project/fiticoin>";
    const std::string URL_WEBSITE = "<https://fiticoin.org>";
