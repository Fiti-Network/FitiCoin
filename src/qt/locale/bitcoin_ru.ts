...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Fiticoin для отправки платежей. Всегда проверяйте сумму и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Fiticoin для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Fiticoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашим адресом Fiticoin, чтобы доказать, что вы им владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Fiticoin addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом Fiticoin</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Запросить платежи (создаёт QR-коды и fiticoin: ссылки)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть fiticoin: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активных соединений с сетью Fiticoin</numerusform><numerusform>%n активных соединений с сетью Fiticoin</numerusform><numerusform>%n активных соединений с сетью Fiticoin</numerusform><numerusform>%n активных соединений с сетью Fiticoin</numerusform></translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Произошла неисправимая ошибка. Fiticoin не может безопасно продолжать работу и будет закрыт.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным Fiticoin-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Fiticoin-клиента на роутере. Работает только если Ваш роутер поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Fiticoin через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети Fiticoin через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Fiticoin через прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Fiticoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить fiticoin: обработчик click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось обработать URI! Это может быть связано с неверным адресом Fiticoin или неправильными параметрами URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Fiticoin (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Fiticoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Fiticoin</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Fiticoin, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>К fiticoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Fiticoin.</translation>
    </message>
    <message>
        <source>Pay To:</source>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Fiticoin, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выберите ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение адресом Fiticoin</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Fiticoin, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Fiticoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Fiticoin</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
