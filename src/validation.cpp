...
#if defined(NDEBUG)
# error "Fiticoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Fiticoin Signed Message:\n";
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // Fiticoin: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
