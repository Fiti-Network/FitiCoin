...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s fiticoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fiticoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fiticoin transaction") + "\n" +
              "  fiticoin-tx [options] -create [commands]   " + _("Create hex-encoded fiticoin transaction") + "\n" +
              "\n";
